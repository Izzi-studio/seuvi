          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="config_fb_link" placeholder="Facebook" id="input-fb_link" class="form-control"><?php echo $config_fb_link; ?></input>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="config_inst_link"  placeholder="Instagram" id="input-inst_link" class="form-control"><?php echo $config_inst_link; ?></input>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="config_tiktok_link"  placeholder="TikTok" id="input-tiktok_link" class="form-control"><?php echo $config_tiktok_link; ?></input>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="config_tg_link"  placeholder="Telegram" id="input-tg_link" class="form-control"><?php echo $config_tg_link; ?></input>
                </div>
              </div>
