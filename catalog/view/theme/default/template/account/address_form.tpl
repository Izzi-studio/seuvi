      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
         ...
         <div class="form-group">
           ...
           <div>
             <?php if ($default) { ?>
               <input type="radio" id="sub_yes" name="default" value="1" checked="checked" />
               <label class="radio-inline" for="sub_yes">
                <?php echo $text_yes; ?>
               </label>

               <input type="radio" id="sub_no" name="default" value="0" />
               <label class="radio-inline" for="sub_no">
                   <?php echo $text_no; ?>
                 </label>
             <?php } else { ?>

               <input type="radio" id="sub_yes" name="default" value="1" />
               <label class="radio-inline" for="sub_yes">
                   <?php echo $text_yes; ?>
               </label>

               <input type="radio" id="sub_no" name="default" value="0" checked="checked" />
               <label class="radio-inline" for="sub_no">
                   <?php echo $text_no; ?>
               </label>
             <?php } ?>
