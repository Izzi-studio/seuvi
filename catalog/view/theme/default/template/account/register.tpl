      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group">
            <div>
              <?php if ($newsletter) { ?>
                <input type="radio" id="n_yes" name="newsletter" value="1" checked="checked" />
                <label for="n_yes" class="radio-inline"><?php echo $text_yes; ?></label>

                <input type="radio" id="n_no" name="newsletter" value="0" />
                <label for="n_no" class="radio-inline"><?php echo $text_no; ?></label>
              <?php } else { ?>
                <input type="radio" id="n_yes" name="newsletter" value="1" />
                <label for="n_yes" class="radio-inline"><?php echo $text_yes; ?></label>

                <input type="radio" id="n_no" name="newsletter" value="0" checked="checked" />
                <label for="n_no" class="radio-inline"><?php echo $text_no; ?></label>
              <?php } ?>
            </div>
          </div>
        ...
        <div class="buttons">
          <div>
            ...
            <?php } else { ?>
            <input type="checkbox" name="agree" id="i_agree" value="1" />
            <?php } ?>
            <label for="i_agree"><?php echo $text_agree; ?></label>
          </div>
