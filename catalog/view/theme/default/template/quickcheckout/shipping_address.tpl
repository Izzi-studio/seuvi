...
<div id="shipping-existing">
  <select name="address_id" class="form-control">
    ...
    <?php if ($address['address_id'] == $address_id) { ?>
	  ...
	  <?php } else { ?>
    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['postcode']; ?></option>
    <?php } ?>
    <?php } ?>
  </select>
</div>
