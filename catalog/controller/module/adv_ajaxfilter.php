...
class ControllerModuleAdvajaxfilter extends Controller {
	...
	public function index($setting)
    {
		...
		if($data['options'] || $data['manufacturers'] || $data['attributes'] || $data['price_slider']) {
			...
			$this->document->addScript('catalog/view/theme/default/js/colorbox/jquery.colorbox-min.js');
			...
			$this->document->addStyle('catalog/view/theme/default/js/colorbox/custom_colorbox.css');
		}
